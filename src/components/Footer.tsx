      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Secure online transactions for everyone. TrustFlow protects both buyers and sellers through our escrow payment system.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/security" className="text-sm text-gray-600 hover:text-primary">Security</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">© {new Date().getFullYear()} TrustFlow. All rights reserved.</p>
